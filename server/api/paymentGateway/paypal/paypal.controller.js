...
const {
  PAYPAL_CLIENT_ID, PAYPAL_SECRET, PAYPAL_MODE, URLS_API,
...
exports.create = async (req, res, transaction) => {
  ...
  createPayment.redirect_urls.return_url = `${URLS_API}/api/transactions/${transaction.id}/complete?status=success`;
  createPayment.redirect_urls.cancel_url = `${URLS_API}/api/transactions/${transaction.id}/complete?status=failed`;
