// Generated on 2017-10-31 using generator-angular-fullstack 4.2.2
'use strict';
...
gulp.task('start:client', cb => {
  whenServerReady(() => {
    open('http://accounts.shoppre.test');
    cb();
  });
});
...
gulp.task('copy:server', () => {
  return gulp.src([
    'package.json',
    'server/components/hbs/templates/*.hbs',
  ], {cwdbase: true})
