class ShipmentFilterController {
  /* @ngInject */
  ...
  open({ all = [] }) {
    return this
      ...
      .open({
        ...
        animation: true,
        templateUrl: 'app/directives/shipment-filter/shipment-filter.html',
        controller: 'ShipmentFilterController',
        controllerAs: '$ctrl',
        resolve: {
          all: () => all,
        },
...
angular
  .module('uiGenApp')
  .controller('ShipmentFilterController', ShipmentFilterController)
  .service('ShipmentFilter', ShipmentFilter);
