...
module.exports = (sequelize, DataTypes) => {
  ...
  Auth.associate = (db) => {
    Auth.hasMany(db.App);
    Auth.hasMany(db.AccessToken);
    Auth.hasMany(db.RefreshToken);
    Auth.hasMany(db.Session);
  };

  Auth.prototype.verifyPassword = function verifyPassword(password, cb) {
  ...
  Auth.prototype.revokeTokens = (db, userId) => {
